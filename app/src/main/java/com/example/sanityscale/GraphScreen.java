...
@Metadata(
        ...
        d2 = {"Lcom/example/sanityscale/GraphScreen;", "Landroidx/appcompat/app/AppCompatActivity;", "()V", "configureBackButton", "", "configureSettingsButton", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "app_debug"}
)
public final class GraphScreen extends AppCompatActivity {
    private HashMap _$_findViewCache;

    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.setContentView(-1300038);
        ...
        if (var10000 == null) {
            ...
            settingsButton.setOnClickListener((OnClickListener)(new OnClickListener() {
                public void onClick(@NotNull View p0) {
                    ...
                    Intent intent = new Intent((Context)GraphScreen.this, SettingsScreen2.class);
    ...
    public final void configureBackButton() {
        ...
        if (var10000 == null) {
            ...
            backButton.setOnClickListener((OnClickListener)(new OnClickListener() {
                public void onClick(@NotNull View p0) {
                    Intrinsics.checkParameterIsNotNull(p0, "p0");
                    Intent intent = new Intent((Context)GraphScreen.this, homeScreen.class);
                    GraphScreen.this.startActivity(intent);
                }
            }));
        }
