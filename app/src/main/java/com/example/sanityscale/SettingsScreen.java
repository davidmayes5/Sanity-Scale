...
@Metadata(
        ...
        d2 = {"Lcom/example/sanityscale/SettingsScreen;", "Landroidx/appcompat/app/AppCompatActivity;", "()V", "configureBackButton", "", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "app_debug"}
)
public final class SettingsScreen extends AppCompatActivity {
        ...
        if (var10000 == null) {
            ...
            backButton.setOnClickListener((OnClickListener)(new OnClickListener() {
                public void onClick(@NotNull View p0) {
                    ...
                    Intent intent = new Intent((Context)SettingsScreen.this, homeScreen.class);
